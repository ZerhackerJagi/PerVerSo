...
public class AdminTest {
	...
	public void AtestEditMAStammdaten() {
		...
		assertFalse(ad1.editMAStammdaten(100002,"Charly","Spina",'m',new Datum(9,9,1996)));
	}
	...
	public void GAusscheidenMA() {
		...
		assertFalse(ad1.ausscheidenMA(100003,new Datum(20,2,2020)));
		assertTrue(ad1.ausscheidenMA(100003,new Datum(20,2,2017)));
		assertFalse(ad1.ausscheidenMA(100004,new Datum(23,5,2017)));			
	}
	...
	public void JtestremoveMA() {
		...
		assertTrue(ad1.removeMA(100003)); // 3 weg 
	}
	
	@Test
	public void KtestEditAZKLimit() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.editAZKLimit(100004,30,100));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //4
		assertTrue(ad1.editAZKLimit(100004,30,100));
	}
	...
	public void KtestEditAZKVertragsdaten() throws Exception {	
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.editAZKVertragsdaten(100005,40,25));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //5
		assertTrue(ad1.editAZKVertragsdaten(100005,40,25));
	}
	
	@Test
	public void LtestAddAZKUeberminuten() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.addAZKUeberminuten(100006,40));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //6
		assertTrue(ad1.addAZKUeberminuten(100006,40));
		assertTrue(ad1.addAZKUeberminuten(100006,-20));
	}
	
	@Test
	public void OtestAddAZKUrlaub() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.addAZKUrlaub(100007,new Datum(12,3,2018),new Datum(10,4,2018),20));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //7
		assertTrue(ad1.addAZKUrlaub(100007,new Datum(12,3,2018),new Datum(10,4,2018),20));
	}
	
	@Test
	public void PtestAZKKrankheit() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.addAZKKrankheit(100008,new Datum(12,3,2018),new Datum(10,4,2018),20));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //8
		assertTrue(ad1.addAZKKrankheit(100008,new Datum(12,3,2018),new Datum(10,4,2018),20));
	}
	
	@Test
	public void QtestRemoveAZKUrlaub() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.removeAZKUrlaub(100009,1));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //9
		assertTrue(ad1.removeAZKUrlaub(100009,1));
	}
	
	@Test
	public void RtestRemoveAZKKrankheit() throws Exception {
		Admin ad1 = new Admin(100000);
		assertFalse(ad1.removeAZKKrankheit(100010,1));
		ad1.addMA("Spina","Charly",'d',new Datum(9,9,1996), new Datum(12,2,2019),1); //10
		assertTrue(ad1.removeAZKKrankheit(100010,1));
	}
